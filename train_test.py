...
def main():
    ...
    parser.add_argument('-l', '--forward-layers', action='store', dest='layers', type='string', nargs=1, default='cac')
    ...
    parser.add_argument('--gado', action='store', dest='gado', type='string', default='GADO_preprocessed.nii.gz')
    ...
    parser.add_argument('--pd', action='store', dest='pd', type='string', default='DP_preprocessed.nii.gz')
    ...
    parser.add_argument('--t2', action='store', dest='t2', type='string', default='T2_preprocessed.nii.gz')
    ...
    parser.add_argument('--t1', action='store', dest='t1', type='string', default='T1_preprocessed.nii.gz')
    parser.add_argument('--mask', action='store', dest='mask', type='string', default='Consensus.nii.gz')
